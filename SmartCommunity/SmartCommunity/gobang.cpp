...
bool Gobang::judge(int x, int y, bool nowWhite)
{
    int count = 0;
...
bool Gobang::judge(int chess[15][15], int x, int y, bool nowWhite)
{
    int count = 0;
    int flag = nowWhite ? 1 : 2;
    //横向
...
void Gobang::keyPressEvent(QKeyEvent* e)
{
    //走子
...
void Gobang::on_back_regret_clicked()
{
